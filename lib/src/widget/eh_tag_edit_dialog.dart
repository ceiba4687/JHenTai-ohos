        ...
        Align(
          ...
          child: TextButton.icon(
            ...
            onPressed: () async {
              ...
              if (result == 'default' || result is Color) {
                setState(() => color = result is Color ? result : null);
              }
            },
          ),
        ),
  ...
  Widget _colorChip(BuildContext context, Color chipColor, Color? value) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: selected
            ? Icon(Icons.check, size: 18, color: ThemeData.estimateBrightnessForColor(chipColor) == Brightness.light ? Colors.black : Colors.white)
            : null,
      ),
    );
  }
